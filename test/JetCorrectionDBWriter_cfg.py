...
process.CondDBCommon.connect = 'sqlite_file:Jec10V3.db' 
...
process.PoolDBOutputService = cms.Service('PoolDBOutputService', 
   ...
   toPut = cms.VPSet( 
      ...
      cms.PSet(
         ...
         tag    = cms.string('JetCorrectorParametersCollection_Jec10V3_AK5TRK'), 
      ...
      cms.PSet(
         ...
         tag    = cms.string('JetCorrectorParametersCollection_Jec10V3_AK7JPT'),
         label  = cms.string('AK7JPT')                                          
      ),
      cms.PSet(
         record = cms.string('IC5Calo'), 
         tag    = cms.string('JetCorrectorParametersCollection_Jec10V3_IC5Calo'), 
         label  = cms.string('IC5Calo') 
      ),
     cms.PSet(
         record = cms.string('IC5PF'), 
         tag    = cms.string('JetCorrectorParametersCollection_Jec10V3_IC5PF'), 
...
process.dbWriterAK5Calo = cms.EDAnalyzer('JetCorrectorDBWriter', 
   era    = cms.untracked.string('Jec10V3'), 
